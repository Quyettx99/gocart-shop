...
export const ourSpecsData = [
  {
    ...
    description:
      "Hưởng dịch vụ giao hàng nhanh, miễn phí cho mọi đơn hàng không có điều kiện, chỉ cần giao hàng đến tận cửa.",
    icon: SendIcon,
    accent: "#05DF72",
  },
  {
    title: "Trả hàng trong 7 ngày",
    description:
      "Thay đổi ý định? Không vấn đề. Trả lại bất kỳ mặt hàng nào trong vòng 7 ngày.",
  ...
  },
  {
    ...
    description:
      "Chúng tôi ở đây để bạn. Nhận trợ giúp chuyên môn từ bộ phận hỗ trợ khách hàng của chúng tôi.",
    icon: HeadsetIcon,
    accent: "#A684FF",
  },
];
