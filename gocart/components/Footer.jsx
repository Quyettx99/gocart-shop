        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
          <div>
            ...
            <p className="max-w-[410px] mt-6 text-sm">
              Chào mừng đến với gocart, điểm đến của bạn cho những thiết bị
              thông minh mới nhất. Từ điện thoại, đồng hồ thông minh đến phụ
              kiện thiết yếu, chúng tôi mang đến những sản phẩm sáng tạo tốt
              nhất — tất cả trong một nơi.
            </p>
