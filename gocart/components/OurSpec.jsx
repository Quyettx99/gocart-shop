  ...
  return (
    <div className="px-6 my-20 max-w-6xl mx-auto">
      <Title
        ...
        description="Chúng tôi cung cấp dịch vụ hạng nhất và sự tiện lợi để đảm bảo trải nghiệm mua sắm của bạn diễn ra mượt mà, an toàn và hoàn toàn không rắc rối."
      />
