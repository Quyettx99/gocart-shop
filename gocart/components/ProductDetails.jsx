    ...
    <div className="flex max-lg:flex-col gap-12">
      ...
      <div className="flex-1">
        ...
        <div className="flex items-end gap-5 mt-10">
          ...
          >
            {!cart[productId] ? "Thêm vào giỏ" : "Xem giỏ"}
          </button>
        </div>
        ...
        <div className="flex flex-col gap-4 text-slate-500">
          ...
          <p className="flex gap-3">
            {" "}
            <CreditCardIcon className="text-slate-400" /> Thanh toán 100% an
            toàn{" "}
          </p>
          <p className="flex gap-3">
            {" "}
            <UserIcon className="text-slate-400" /> Được tin dùng bởi các thương
            hiệu hàng đầu{" "}
          </p>
        </div>
      </div>
