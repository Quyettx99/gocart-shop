...
export default function AdminStores() {
    ...
    return !loading ? (
        <div className="text-slate-500 mb-28">
            <h1 className="text-2xl">Cửa hàng <span className="text-slate-800 font-medium">Hiện có</span></h1>
                        ...
                        <div key={store.id} className="bg-white border border-slate-200 rounded-lg shadow-sm p-6 flex max-md:flex-col gap-4 md:items-end max-w-4xl" >
                            ...
                            <div className="flex items-center gap-3 pt-2 flex-wrap">
                                ...
                                <label className="relative inline-flex items-center cursor-pointer text-gray-900">
                                    <input type="checkbox" className="sr-only peer" onChange={() => toast.promise(toggleIsActive(store.id), { loading: "Đang cập nhật..." })} checked={store.isActive} />
