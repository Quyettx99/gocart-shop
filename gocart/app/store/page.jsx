...
export default function Dashboard() {
    ...
    return (
        <div className="text-slate-500 mb-28">
            <h1 className="text-2xl">Người bán<span className="text-slate-800 font-medium">Bảng điều khiển</span></h1>
                        ...
                        <div>
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="font-light text-slate-500">{new Date(review.createdAt).toLocaleDateString()}</p>
                                </div>
                            </div>
